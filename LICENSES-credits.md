...
| `catalog-birds-05` | Aves | 3 | GBIF Species Match | Wikimedia Commons; nove arquivos CC0/CC BY-SA com créditos no módulo do lote |
...
| `catalog-invertebrates-07` | Invertebrados | 3 | GBIF Species Match | Wikimedia Commons; nove arquivos CC0/CC BY-SA com créditos no módulo do lote |
...
O lote `catalog-invertebrates-07` usa três espécies e nove arquivos Commons selecionados a partir de metadados de licença consultados na API pública. Os autores e licenças declarados são Charles J. Sharp (CC BY-SA 4.0), Didier Descouens (CC BY-SA 4.0), NSG group (CC0) e Evaldo Resende (CC BY-SA 4.0). As páginas individuais estão nas `sourceUrl` dos registros.
