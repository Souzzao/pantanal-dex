...
| 9–11 | Peixes | [x] `catalog-fish-01` e `catalog-fish-02` adicionados com seis espécies; revisão regional e conservação pendentes. |
...
4. `[x]` Expandir lotes modulares: `catalog-birds-02` e `catalog-fish-02` adicionaram seis espécies; continuar novos lotes de aves, peixes e invertebrados.
