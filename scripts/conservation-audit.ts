...
const expectedIds = ["hoplias-malabaricus", "prochilodus-lineatus", "megaceryle-torquata", "egretta-thula", "heliconius-erato", "cateto", "phoneutria-nigriventer", "zungaro-jahu", "tucano-toco", "arara-caninde", "veado-campeiro", "pintado", "pacu", "piraputanga", "caranguejo-agua-doce", "camarao-agua-doce"];
