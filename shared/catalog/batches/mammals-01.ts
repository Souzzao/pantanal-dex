  ...
  species: [
    {
      ...
      sources: [
        { title: "GBIF Species Match — Chrysocyon brachyurus", url: "https://api.gbif.org/v1/species/match?name=Chrysocyon%20brachyurus" },
    ...
    },
    {
      ...
      sources: [
        { title: "GBIF Species Match — Tayassu pecari", url: "https://api.gbif.org/v1/species/match?name=Tayassu%20pecari" },
        { title: "ICMBio — Mosaico Pantanal (Ocorrência)", url: "https://www.gov.br/icmbio/pt-br/acesso-a-informacao/participacao-social/resumo_executivo_mosaico_pantanal.pdf" }
      ],
    },
    {
      ...
      sources: [
        { title: "GBIF Species Match — Pecari tajacu", url: "https://api.gbif.org/v1/species/match?name=Pecari%20tajacu" },
        { title: "ICMBio — Mosaico Pantanal (Ocorrência)", url: "https://www.gov.br/icmbio/pt-br/acesso-a-informacao/participacao-social/resumo_executivo_mosaico_pantanal.pdf" }
      ],
    },
  ],
