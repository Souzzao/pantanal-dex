...
const portaria148JauUrl = portaria148Url;
const salveTucanoUrl = "https://salve.icmbio.gov.br/salve/api/pdf/doi/382b574f73347872452b77383535307574712f6f314e7937426a35584f6d755a4c3167726c7354686d64733d";
const icmbioJauUrl = "https://revistaeletronica.icmbio.gov.br/BioBR/article/view/565";
const portaria148ArmadeiraUrl = portaria148Url;
const salveCatetoUrl = "https://salve.icmbio.gov.br/salve/api/pdf/doi/382b574f73347872452b77383535307574712f6f31507449386f55462b6d6e42502f35316850317a7769493d";
const portaria148DancaUrl = portaria148Url;
...
export const conservationReviewRecords: readonly ConservationReviewRecord[] = [
  { speciesId: "heliconius-erato", scientificName: "Heliconius erato", status: "confirmed", finding: "not-listed", sourceKind: "Portaria MMA/ICMBio", sourceUrl: portaria148DancaUrl, decisionRule: "Registrar como não listado somente após busca exata na lista nacional oficial vigente; não converter ausência em LC ou em categoria de baixo risco.", evidence: "A Portaria MMA nº 148/2022 foi extraída e pesquisada por Heliconius erato, Heliconius erato phyllis e variações do nome, sem correspondência exata para o táxon específico ou para a subespécie consultada. Outros Lepidoptera e Nymphalidae presentes no anexo não foram confundidos com a dança-ninfas. Finding oficial limitado à lista nacional consultada; nenhuma categoria de ameaça foi inferida.", checkedAt },
  { speciesId: "cateto", scientificName: "Pecari tajacu", status: "confirmed", category: "LC", sourceKind: "SALVE", sourceUrl: salveCatetoUrl, decisionRule: "Promover a categoria somente com correspondência taxonômica exata na ficha oficial do SALVE/ICMBio.", evidence: "A ficha oficial do ICMBio/SALVE avalia diretamente Pecari tajacu (Linnaeus, 1758) e atribui Menos Preocupante (LC), com data da categoria em 08/02/2018 e publicação em 2023. A justificativa reconhece ampla distribuição, populações saudáveis na maioria dos biomas e ressalva a expansão do javali como ameaça local; a avaliação regional não altera a categoria da espécie.", checkedAt },
  { speciesId: "phoneutria-nigriventer", scientificName: "Phoneutria nigriventer", status: "confirmed", finding: "not-listed", sourceKind: "Portaria MMA/ICMBio", sourceUrl: portaria148ArmadeiraUrl, decisionRule: "Registrar como não listado somente após busca exata na lista nacional oficial vigente; não converter ausência em LC nem inferir risco a partir de fonte médica ou de distribuição geral.", evidence: "A Portaria MMA nº 148/2022 foi extraída e pesquisada por Phoneutria nigriventer, nigriventer, Phoneutria e Ctenus, sem correspondência exata para o táxon do catálogo. Outros táxons de Ctenidae presentes no anexo não foram confundidos com a aranha-armadeira. Finding oficial limitado à lista nacional consultada; nenhuma categoria de ameaça foi inferida.", checkedAt },
  { speciesId: "zungaro-jahu", scientificName: "Zungaro jahu", status: "confirmed", finding: "not-listed", sourceKind: "Portaria MMA/ICMBio", sourceUrl: portaria148JauUrl, decisionRule: "Registrar como não listado somente após busca exata na lista nacional oficial vigente; não promover categoria com base em grafia divergente, fonte secundária ou snippet.", evidence: "A Portaria MMA nº 148/2022 foi extraída e pesquisada por Zungaro jahu, Zungaro zungaro e variações de jahu, sem correspondência exata para o táxon do catálogo. Uma publicação oficial do ICMBio menciona a grafia divergente Zungaru jahu entre peixes Vulneráveis, mas essa forma não constitui correspondência taxonômica exata suficiente para promover NT ou VU. Finding oficial limitado à lista nacional consultada; nenhuma categoria foi inferida.", checkedAt },
  { speciesId: "tucano-toco", scientificName: "Ramphastos toco", status: "confirmed", category: "LC", sourceKind: "SALVE", sourceUrl: salveTucanoUrl, decisionRule: "Promover a categoria somente com correspondência taxonômica exata na ficha oficial do SALVE/ICMBio.", evidence: "A ficha oficial do ICMBio/SALVE avalia diretamente Ramphastos toco Statius Muller, 1776 e atribui Menos Preocupante (LC), com data da categoria em 05/10/2018. A justificativa reconhece ampla distribuição e ocorrência no Brasil; a categoria é da espécie, não de uma subespécie diferente.", checkedAt },
