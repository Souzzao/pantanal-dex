...
export const species: Species[] = [
  ...
  {
    id: "jaguatirica", commonName: "Jaguatirica", scientificName: "Leopardus pardalis", group: "Mamíferos", environments: ["Matas", "Bordas de mata"],
    description: "Felino de médio porte, noturno e discreto, associado a matas e corredores de vegetação.", physicalCharacteristics: "Pelagem amarelada com manchas e rosetas, cauda curta e olhos adaptados à baixa luz.", habitat: "Matas ciliares, capões, cerrados e bordas de mata.", behavior: "Solitária, territorial e principalmente noturna.", diet: "Pequenos mamíferos, aves, répteis e anfíbios.", curiosities: ["As manchas ajudam na camuflagem entre sombras e folhagem.", "Pode utilizar corredores de mata para se deslocar entre áreas."], distribution: "Ampla distribuição nas Américas, incluindo o Pantanal.", ecologicalImportance: "Controla populações de pequenos vertebrados.", conservationStatus: "Pouco preocupante", images: [commons("Leopardus pardalis.jpg", "Wikimedia Commons"), commons("Ocelot Pantanal.jpg", "Wikimedia Commons"), commons("Ocelot resting.jpg", "Wikimedia Commons")], sources: [{ title: "IUCN Red List — Leopardus pardalis", url: "https://www.iucnredlist.org/search?query=Leopardus%20pardalis&searchType=species" }]
  },
  {
    id: "mao-pelada", commonName: "Mão-pelada", scientificName: "Procyon cancrivorus", group: "Mamíferos", environments: ["Rios e corixos", "Matas"],
    description: "Mamífero noturno que explora margens de rios, áreas úmidas e matas em busca de alimento.", physicalCharacteristics: "Máscara facial escura, cauda anelada e dedos longos.", habitat: "Matas ciliares, banhados, rios e áreas alagadas.", behavior: "Noturno, solitário e habilidoso ao manipular alimentos com as patas.", diet: "Crustáceos, frutos, insetos, anfíbios e pequenos vertebrados.", curiosities: ["As patas sensíveis auxiliam na procura de alimento em água rasa.", "A cauda anelada é uma marca visual característica."], distribution: "América Central e América do Sul, incluindo o Pantanal.", ecologicalImportance: "Participa do controle de invertebrados e da dispersão de sementes.", conservationStatus: "Pouco preocupante", images: [commons("Procyon cancrivorus.jpg", "Wikimedia Commons"), commons("Crab-eating raccoon.jpg", "Wikimedia Commons"), commons("Procyon cancrivorus wetland.jpg", "Wikimedia Commons")], sources: [{ title: "IUCN Red List — Procyon cancrivorus", url: "https://www.iucnredlist.org/search?query=Procyon%20cancrivorus&searchType=species" }]
  },
  {
    id: "cachorro-do-mato", commonName: "Cachorro-do-mato", scientificName: "Cerdocyon thous", group: "Mamíferos", environments: ["Campos", "Bordas de mata"],
    description: "Canídeo generalista que ocupa campos, cerrados e bordas de mata no Pantanal.", physicalCharacteristics: "Pelagem cinza-amarronzada, pernas curtas e focinho estreito.", habitat: "Campos, cerrados, matas abertas e áreas alteradas.", behavior: "Atividade crepuscular e noturna, geralmente solitário ou em casal.", diet: "Frutos, insetos, pequenos vertebrados e carniça.", curiosities: ["Adapta-se a diferentes ambientes e recursos alimentares.", "Pode atuar como dispersor de sementes de frutos nativos."], distribution: "Grande parte da América do Sul, incluindo o Pantanal.", ecologicalImportance: "Conecta cadeias alimentares e dispersa sementes.", conservationStatus: "Pouco preocupante", images: [commons("Cerdocyon thous.jpg", "Wikimedia Commons"), commons("Crab-eating fox.jpg", "Wikimedia Commons"), commons("Cerdocyon thous cerrado.jpg", "Wikimedia Commons")], sources: [{ title: "IUCN Red List — Cerdocyon thous", url: "https://www.iucnredlist.org/search?query=Cerdocyon%20thous&searchType=species" }]
  },
  {
    id: "macaco-prego", commonName: "Macaco-prego", scientificName: "Sapajus cay", group: "Mamíferos", environments: ["Matas", "Bordas de mata"],
    description: "Primata arborícola inteligente, comum em fragmentos e corredores florestais do Pantanal.", physicalCharacteristics: "Corpo robusto, mãos hábeis, cauda semipreênsil e face expressiva.", habitat: "Matas ciliares, capões e bordas florestais.", behavior: "Diurno, social e ativo na copa e no sub-bosque.", diet: "Frutos, sementes, folhas, insetos e pequenos animais.", curiosities: ["Usa as mãos para explorar alimentos e objetos.", "Vive em grupos com relações sociais complexas."], distribution: "Centro-sul da América do Sul, com ocorrência no Pantanal.", ecologicalImportance: "Dispersa sementes e controla invertebrados.", conservationStatus: "Pouco preocupante", images: [commons("Sapajus cay.jpg", "Wikimedia Commons"), commons("Black-striped capuchin.jpg", "Wikimedia Commons"), commons("Sapajus cay tree.jpg", "Wikimedia Commons")], sources: [{ title: "IUCN Red List — Sapajus cay", url: "https://www.iucnredlist.org/search?query=Sapajus%20cay&searchType=species" }]
  },
  {
    id: "anhuma", commonName: "Anhuma", scientificName: "Anhima cornuta", group: "Aves", environments: ["Áreas alagadas", "Rios e corixos"],
    description: "Ave de áreas úmidas reconhecida pelo espinho córneo na cabeça e pelo chamado forte.", physicalCharacteristics: "Grande porte, corpo escuro, asas com esporões e projeção córnea na testa.", habitat: "Brejos, baías, campos alagados e margens com vegetação aquática.", behavior: "Alimenta-se em áreas úmidas e costuma permanecer em casais ou pequenos grupos.", diet: "Folhas, brotos, sementes e plantas aquáticas.", curiosities: ["O espinho frontal é uma estrutura queratinizada característica.", "Pode ser avistada em margens abertas de baías pantaneiras."], distribution: "Norte e centro da América do Sul, incluindo o Pantanal.", ecologicalImportance: "Participa do fluxo de energia entre vegetação aquática e consumidores.", conservationStatus: "Pouco preocupante", images: [commons("Anhima cornuta.jpg", "Wikimedia Commons"), commons("Horned screamer wetland.jpg", "Wikimedia Commons"), commons("Anhima cornuta Pantanal.jpg", "Wikimedia Commons")], sources: [{ title: "BirdLife Data Zone — Anhima cornuta", url: "https://datazone.birdlife.org/species/factsheet/horned-screamer-anhima-cornuta" }]
  },
  {
    id: "urubu-rei", commonName: "Urubu-rei", scientificName: "Sarcoramphus papa", group: "Aves", environments: ["Matas", "Bordas de mata"],
    description: "Abutre de grande porte que utiliza áreas abertas para planar e matas para abrigo.", physicalCharacteristics: "Plumagem branca e preta, cabeça colorida e bico forte.", habitat: "Matas, cerrados, bordas e grandes áreas abertas.", behavior: "Plana por longos períodos e localiza carcaças com auxílio de outras espécies.", diet: "Carcaças de animais.", curiosities: ["A cabeça sem penas facilita a higiene durante a alimentação.", "Pode aproveitar correntes térmicas para economizar energia."], distribution: "América Central e América do Sul, incluindo o Pantanal.", ecologicalImportance: "Remove carcaças e reduz riscos sanitários no ambiente.", conservationStatus: "Pouco preocupante", images: [commons("Sarcoramphus papa.jpg", "Wikimedia Commons"), commons("King vulture flight.jpg", "Wikimedia Commons"), commons("Sarcoramphus papa head.jpg", "Wikimedia Commons")], sources: [{ title: "IUCN Red List — Sarcoramphus papa", url: "https://www.iucnredlist.org/search?query=Sarcoramphus%20papa&searchType=species" }]
  },
  {
    id: "jacare-coroa", commonName: "Jacaré-coroa", scientificName: "Paleosuchus palpebrosus", group: "Répteis", environments: ["Rios e corixos", "Matas"],
    description: "Pequeno jacaré de água doce associado a córregos, rios e áreas de mata.", physicalCharacteristics: "Focinho curto, osteodermos marcados e corpo compacto.", habitat: "Córregos, riachos, rios de menor porte e margens sombreadas.", behavior: "Discreto, principalmente noturno e dependente de abrigos próximos à água.", diet: "Peixes, crustáceos, insetos e pequenos vertebrados.", curiosities: ["É uma das menores espécies de jacaré.", "A cobertura óssea protege o dorso contra impactos e predadores."], distribution: "Bacias da América do Sul, incluindo áreas do Pantanal.", ecologicalImportance: "Preda organismos aquáticos e ajuda a equilibrar cadeias de riachos.", conservationStatus: "Pouco preocupante", images: [commons("Paleosuchus palpebrosus.jpg", "Wikimedia Commons"), commons("Cuvier's dwarf caiman.jpg", "Wikimedia Commons"), commons("Paleosuchus palpebrosus river.jpg", "Wikimedia Commons")], sources: [{ title: "IUCN Red List — Paleosuchus palpebrosus", url: "https://www.iucnredlist.org/search?query=Paleosuchus%20palpebrosus&searchType=species" }]
  },
  {
    id: "traira", commonName: "Traíra", scientificName: "Hoplias malabaricus", group: "Peixes", environments: ["Rios e corixos", "Áreas alagadas"],
    description: "Peixe predador de águas calmas, comum em lagoas, corixos e áreas de vegetação aquática.", physicalCharacteristics: "Corpo alongado, boca ampla e coloração parda camuflada.", habitat: "Lagoas, baías, corixos, rios lentos e áreas alagadas.", behavior: "Predador de emboscada, permanece entre estruturas submersas.", diet: "Peixes, crustáceos, insetos e pequenos vertebrados aquáticos.", curiosities: ["A camuflagem favorece ataques rápidos a partir de abrigos.", "Tolera variações sazonais de oxigênio em águas rasas."], distribution: "Ampla distribuição em bacias sul-americanas, incluindo o Pantanal.", ecologicalImportance: "Regula populações de pequenos peixes e invertebrados aquáticos.", conservationStatus: "Pouco preocupante", images: [commons("Hoplias malabaricus.jpg", "Wikimedia Commons"), commons("Traira fish.jpg", "Wikimedia Commons"), commons("Hoplias malabaricus river.jpg", "Wikimedia Commons")], sources: [{ title: "FishBase — Hoplias malabaricus", url: "https://www.fishbase.se/summary/Hoplias-malabaricus.html" }]
  },
];
