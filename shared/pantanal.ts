...
const legacySpecies: Species[] = [
  {
    ...
    description: "Grande ave pernalta símbolo do Pantanal, frequentemente observada em áreas abertas e alagadas.", physicalCharacteristics: "Plumagem branca, cabeça preta e papo vermelho, com pernas longas e bico robusto.", habitat: "Campos inundáveis, baías, vazantes e margens de rios.", behavior: "Constrói ninhos altos e pode ser visto forrageando em águas rasas.", diet: "Peixes, anfíbios, répteis, insetos e pequenos vertebrados.", curiosities: ["É uma das maiores aves voadoras da América do Sul.", "Seu ninho pode ser reutilizado por vários anos."], distribution: "América Central e América do Sul, incluindo todo o Pantanal.", ecologicalImportance: "Ajuda a indicar a disponibilidade de alimento e a saúde das áreas úmidas.", images: [commons("Jabiru mycteria - Brazil.jpg", "Wikimedia Commons"), commons("Jabiru mycteria flying.jpg", "Wikimedia Commons"), commons("Jabiru mycteria nest.jpg", "Wikimedia Commons")], sources: [{ title: "GBIF Species Match — Jabiru mycteria", url: "https://api.gbif.org/v1/species/match?name=Jabiru%20mycteria" }]
  },
  {
