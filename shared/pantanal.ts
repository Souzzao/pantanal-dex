...
export const species: Species[] = [
  {
    ...
    description: "Grande ave pernalta símbolo do Pantanal, frequentemente observada em áreas abertas e alagadas.", physicalCharacteristics: "Plumagem branca, cabeça preta e papo vermelho, com pernas longas e bico robusto.", habitat: "Campos inundáveis, baías, vazantes e margens de rios.", behavior: "Constrói ninhos altos e pode ser visto forrageando em águas rasas.", diet: "Peixes, anfíbios, répteis, insetos e pequenos vertebrados.", curiosities: ["É uma das maiores aves voadoras da América do Sul.", "Seu ninho pode ser reutilizado por vários anos."], distribution: "América Central e América do Sul, incluindo todo o Pantanal.", ecologicalImportance: "Ajuda a indicar a disponibilidade de alimento e a saúde das áreas úmidas.", conservationStatus: "Pouco preocupante", images: [commons("002 Jabiru feeding its babies in their nest in Encontro das Águas State Park Photo by Giles Laurent.jpg", "Giles Laurent", "CC BY-SA 4.0"), commons("Jabiru (Jabiru mycteria) 2.JPG", "Charles J. Sharp", "CC BY-SA 4.0"), commons("Jabirus (Jabiru mycteria) on nest.JPG", "Charles J. Sharp", "CC BY-SA 4.0")], sources: [{ title: "IUCN Red List — Jabiru mycteria", url: "https://www.iucnredlist.org/species/22697710/93625378" }]
  },
  {
  ...
  },
  {
    ...
    description: "Grande mamífero herbívoro que percorre matas, veredas e margens de rios no Pantanal.", physicalCharacteristics: "Corpo volumoso, focinho alongado e pelagem castanha curta.", habitat: "Matas ciliares, capões e áreas próximas à água.", behavior: "Solitária, geralmente mais ativa no crepúsculo e à noite.", diet: "Folhas, frutos, brotos e outras partes de plantas.", curiosities: ["É uma importante dispersora de sementes.", "Nada bem e usa a água para fugir de ameaças."], distribution: "América do Sul a leste dos Andes, incluindo o Pantanal.", ecologicalImportance: "Transporta sementes entre diferentes ambientes e contribui para a regeneração florestal.", conservationStatus: "Vulnerável", images: [commons("036 South American tapir in Encontro das Águas State Park Photo by Giles Laurent.jpg", "Giles Laurent", "CC BY-SA 4.0"), commons("South American tapir (Tapirus terrestris).JPG", "Charles J. Sharp", "CC BY-SA 4.0"), commons("South American tapir (Tapirus terrestris) swimming Cristalino.jpg", "Charles J. Sharp", "CC BY-SA 4.0")], sources: [{ title: "IUCN Red List — Tapirus terrestris", url: "https://www.iucnredlist.org/search?query=Tapirus%20terrestris&searchType=species" }]
  },
  {
  ...
  },
  {
    ...
    description: "Maior cervídeo da América do Sul, associado a várzeas, brejos e campos inundáveis.", physicalCharacteristics: "Pernas longas, pelagem castanho-avermelhada e galhadas ramificadas nos machos.", habitat: "Brejos, baías, campos inundáveis e margens de rios.", behavior: "Usa áreas alagadas como abrigo e desloca-se em busca de vegetação aquática.", diet: "Gramíneas, plantas aquáticas, folhas e brotos.", curiosities: ["As adaptações das pernas favorecem o deslocamento em terrenos úmidos.", "A espécie depende da manutenção de áreas úmidas conectadas."], distribution: "Centro e sul da América do Sul, com ocorrência no Pantanal.", ecologicalImportance: "Participa da dinâmica da vegetação de áreas úmidas e dispersa sementes.", conservationStatus: "Vulnerável", images: [commons("001 Marsh deer and Pink Ipê tree in Encontro das Águas State Park Photo by Giles Laurent.jpg", "Giles Laurent", "CC BY-SA 4.0"), commons("Blastocerus dichotomus in Jardim Zoológico de Curitiba.jpg", "Wilfredor", "CC0"), commons("044 Marsh deer in Encontro das Águas State Park Photo by Giles Laurent.jpg", "Giles Laurent", "CC BY-SA 4.0")], sources: [{ title: "IUCN Red List — Blastocerus dichotomus", url: "https://www.iucnredlist.org/search?query=Blastocerus%20dichotomus&searchType=species" }]
  },
  {
    id: "ema", commonName: "Ema", scientificName: "Rhea americana", group: "Aves", environments: ["Campos", "Bordas de mata"],
    description: "Ave corredora de grande porte que ocupa campos e áreas abertas do Pantanal.", physicalCharacteristics: "Pescoço longo, asas reduzidas, pernas fortes e plumagem parda.", habitat: "Campos, cerrados e áreas abertas com vegetação baixa.", behavior: "Vive em grupos e corre rapidamente quando perturbada.", diet: "Frutos, sementes, folhas e pequenos animais.", curiosities: ["O macho participa da incubação e do cuidado dos filhotes.", "As asas ajudam no equilíbrio durante a corrida."], distribution: "América do Sul, com ocorrência em áreas abertas do Pantanal.", ecologicalImportance: "Dispersa sementes e integra as cadeias alimentares dos campos.", conservationStatus: "Pouco preocupante", images: [commons("032 Greater rhea and Pink Ipê trees in Encontro das Águas State Park Photo by Giles Laurent.jpg", "Giles Laurent", "CC BY-SA 4.0"), commons("Erfurt - Thüringer Zoopark - Rhea americana 01.jpg", "H. Zell", "CC BY-SA 3.0"), commons("Greater rhea (Rhea americana).JPG", "Charles J. Sharp", "CC BY-SA 4.0")], sources: [{ title: "IUCN Red List — Rhea americana", url: "https://www.iucnredlist.org/search?query=Rhea%20americana&searchType=species" }]
  },
  {
